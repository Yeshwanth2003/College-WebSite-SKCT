...
export default function XmResults() {
     ...
     useEffect(()=>{
        import("../../DataCenter/subComponentsData/XamDatas/xmNotifyData")
            ...
            <div className="xmreult-link-holder">
               {
                    ...
                    xmResultData.map((elem,index)=>{
                         return(
                              <>
                              <XmResultsCard NAME={elem.name} LINK={elem.url} key={index.toString()}/>
                              </>
                         )
                    })
               }
      ...
      >
        <div className="xmresultCard-contentDiv">
          ...
          <div className="xmresultcard-pDiv">
               <p style={{color:'blue'}} className="xmresult-card-p">{NAME}</p>
          </div>
        </div>
      </a>
    </>
