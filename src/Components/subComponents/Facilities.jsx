...
export default function Facilities() {
  ...
  useImport(
    "subComponentsData/CampusLife/Facilities/facilitiesData",
    ({ err, data }) => {
    ...
    <>
      <div className="facilityCard-wrapper">
        ...
        <div className="facilityCard-div2">
          <p className="facilityCard-p">{DESE}</p>
        </div>
      </div>
    </>
  );
      ...
      <li className="facilityNavCard-li">
        <div className="facilityNavCard-wrapper">
          ...
          <div className="facilityNavCard-textDiv">
            <h4
              id="facilityNavButton"
              className="facilityNavCard-h3"
              number={`${NUMBER}`}
            >
              {NAME}
            </h4>
