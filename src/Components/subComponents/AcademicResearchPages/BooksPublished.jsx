...
export default function BooksPublished() {
  ...
  function FilterResult(event) {
    ...
    if (event.target.value.trim().length === 0) {
      setBpData(maniBpData);
      return;
    }
    setBpData(
      maniBpData.filter((val) => {
        return (
          val.title.includes(searchVal) ||
          val.pdetails.includes(searchVal) ||
  ...
  return (
    <>
      <div className="bp-conntent-div">
        <div className="bp-heading-div">
          <h2 className="bp-heading">BOOKS PUBLISHED</h2>
          <div className="bp-search-wrapper">
            <div className="bp-search-div">
              <input
                type="text"
        ...
        <div className="bp-body">
          <table className="bp-table">
            <thead className="bp-th">
              <tr className="bp-tr">
                <td className="bp-td">S.NO</td>
                <td className="bp-td">Author{"(s)"} Name</td>
                <td className="bp-td">Title of the Book</td>
                <td className="bp-td">Publication Details</td>
              </tr>
            </thead>
